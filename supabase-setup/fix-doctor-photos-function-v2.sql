-- Fix doctor functions to handle profile photos (Version 2)
-- Run this in your Supabase SQL Editor

-- Drop existing functions to avoid type conflicts
DROP FUNCTION IF EXISTS create_mr_doctor_assignment(UUID, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT);
DROP FUNCTION IF EXISTS update_mr_doctor_assignment(UUID, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT);
DROP FUNCTION IF EXISTS delete_mr_doctor_assignment(UUID);
